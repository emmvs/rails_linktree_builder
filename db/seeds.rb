...
Click.create!(link: le_wagon, user_agent: 'Mozilla/5.0', device_type: 'Mobile', country: 'Israel', city: 'Tel Aviv', clicked_at: Time.current)
Click.create!(link: app, user_agent: 'Mozilla/5.0', device_type: 'Desktop', country: 'USA', city: 'New York', clicked_at: Time.current)
Click.create!(link: website, user_agent: 'Mozilla/5.0', device_type: 'Mobile', country: 'Germany', city: 'Berlin', clicked_at: Time.current)
Click.create!(link: love_letter, user_agent: 'Mozilla/5.0', device_type: 'Mobile', country: 'Sweden', city: 'Växjö', clicked_at: Time.current)
